...
const SvgCloseLineRegular = (
  ...
  return (
    ...
    >
      <path
        d="M21.446 24.003 11.168 34.29c-.7.7-.705 1.845-.005 2.555.7.7 1.845.695 2.555-.005l10.278-10.288 10.292 10.282c.7.71 1.836.705 2.536-.005.71-.7.714-1.835.004-2.535L26.546 24.003l10.278-10.287c.7-.7.704-1.845.004-2.555a1.802 1.802 0 0 0-2.542.003l-10.29 10.289L13.704 11.16a1.79 1.79 0 0 0-1.268-.528 1.808 1.808 0 0 0-1.27 3.08l10.28 10.29Z"
        fill={fill}
      />
    </svg>
  )
